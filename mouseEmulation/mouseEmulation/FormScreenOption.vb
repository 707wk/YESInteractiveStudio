Public Class FormScreenOption
    ...
    Private Sub changeLanguage()
        ...
        Me.Text = $"{If(selectLanguageId = 0, "屏幕设置", "Display Setting")}"

        DataGridView1.Columns(0).HeaderText = $"{If(selectLanguageId = 0, "显示", "Show")}"
        DataGridView1.Columns(1).HeaderText = $"{If(selectLanguageId = 0, "屏幕序号", "Screen Id")}"
        DataGridView1.Columns(2).HeaderText = $"{If(selectLanguageId = 0, "备注", "remark")}"
        DataGridView1.Columns(3).HeaderText = $"{If(selectLanguageId = 0, "详细信息", "Information")}"
    End Sub
End Class