...
OutFile "InteractiveStudioSetup_1.2.3.exe"
...
Section "MainSection" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "InteractiveStudio\bin\InteractiveStudio.exe.config"
  ...
  File "InteractiveStudio\bin\InteractiveStudio.exe"
  SetOutPath "$INSTDIR\DLL"
  SetOverwrite try
  File /r "InteractiveStudio\bin\DLL\*.*"
  SetOutPath "$INSTDIR\Help"
  File /r "InteractiveStudio\bin\Help\*.*"
  SetOutPath "$INSTDIR\Lang"
  File /r "InteractiveStudio\bin\Lang\*.*"
  SetOutPath "$INSTDIR\Nova"
  File /r "InteractiveStudio\bin\Nova\*.*"
SectionEnd
