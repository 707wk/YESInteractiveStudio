...
Public Class FormControlOption
    ...
    Private Sub changeLanguage()
        ...
        DataGridView1.Columns(0).HeaderText = $"{If(selectLanguageId = 0, "控制器序号", "Control Id")}"
        DataGridView1.Columns(2).HeaderText = $"{If(selectLanguageId = 0, "子网掩码", "Mask")}"
        DataGridView1.Columns(3).HeaderText = $"{If(selectLanguageId = 0, "网关", "Gateway")}"
    End Sub
End Class