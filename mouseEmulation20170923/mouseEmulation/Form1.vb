...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
        Me.Text = My.Application.Info.Title + "0923"
        ...
        '定时复位时间参数读取
        ResetTimeMin = CInt(tmp2.GetINI("SYS", "ResetTimeMin", "", ".\setting.ini"))
        If ResetTimeMin <= 0 Then
            Timer1.Enabled = False
        Else
            Timer1.Interval = ResetTimeMin * 60 * 1000
        End If
    ...
    Private Sub Form1_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        ...
        tmp2.WriteINI("SYS", "ResetTimeMin", ResetTimeMin, ".\setting.ini")
    ...
    End Sub
    '建立一个委托函数  VB#中禁止跨线程直接访问控件，InvokeRequired是为了解决这个问题而产生的，
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        If Timer1.Interval = 0 Then
            ...
            Exit Sub
        End If
        If ToolStripButton1.Text = "未连接" Or ToolStripButton1.Text = "Disconnect" Then
            Dim sendByte(4 - 1) As Byte
            Dim sendstr As String = "aadb0101" '强制复位
            For i As Integer = 0 To sendByte.Length - 1
                sendByte(i) = Val($"&H{sendstr(i * 2)}{ sendstr(i * 2 + 1)}")
